...
#SBATCH --job-name=run_Elmer_jureca_N4_n1_c128_ML4
...
export RUNDIR="${BASEDIR}/runs/run_Elmer_jureca_N${SLURM_NNODES}_n${SLURM_NTASKS_PER_NODE}_c${SLURM_CPUS_PER_TASK}_ML${MESH_LEVEL}_${SLURM_JOB_ID}"
